          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              ...
              >
                ...
                Transforming Ideas Into <span className="text-primary">Seamless User Experiences</span>
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                Don&apos;t settle for average. Let&apos;s create something extraordinary. Get started with a free consultation today and see how MA Design can elevate your brand in the digital sphere.
                </p>
                ...
                <div>
                  <p className="mb-4 text-center text-base font-medium text-white/60">
                    We&apos;re able to build your vision on many frameworks
                  </p>
                  <div
            ...
            <div className="w-full px-4">
              ...
              >
                <div className="mt-16">
                  <a href="https://www.oumar-inc.co.za/">
                  <Image
                    src="/images/hero/OA.png"
                    alt="hero"
