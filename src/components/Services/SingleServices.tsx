...
const SingleServices = ({ Service }: { Service: Services }) => {
  const { icon, title, paragraph, btn, btnLink } = Service;
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/4 item-center justify-center bg-white shadow-xl rounded-xl bg-opacity-60 backdrop-filter backdrop-blur-lg ">
      <div className="wow fadeInUp group mb-6 mt-4" data-wow-delay=".15s">
        ...
        <p className="mb-8 text-body-color dark:text-white lg:mb-11">
          {paragraph}
        </p>
        <Link
          href={btnLink}
